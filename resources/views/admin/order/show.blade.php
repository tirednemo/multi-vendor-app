...
@push('scripts')
    <script>
        $(document).ready(function() {
            ...
            var paymentStatusSelect = $('#payment_status');

            function togglePaymentStatusSelect() {
                var selectedOrderStatus = orderStatusSelect.val();
                console.log(selectedOrderStatus)
                if (selectedOrderStatus['status'] === 'Delivered') {
                    paymentStatusSelect.prop('disabled', false);
                } else {
                    paymentStatusSelect.prop('disabled', true);
                }
            }
            togglePaymentStatusSelect();
            orderStatusSelect.on('change', togglePaymentStatusSelect);
        });
